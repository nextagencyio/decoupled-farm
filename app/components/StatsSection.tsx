...
const defaultStats = [
  { value: '150', label: 'Acres of Farmland', icon: 'leaf' },
  { value: '4th', label: 'Generation Farmers', icon: 'sun' },
  { value: '50+', label: 'Crop Varieties', icon: 'droplets' },
  { value: '30', label: 'Years Organic', icon: 'tree' },
]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-lg">
            Four generations of sustainable farming, nurturing the land and our community.
          </p>
        </div>
