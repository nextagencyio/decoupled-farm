...
export default function HeroSection({ homepageContent }: HeroSectionProps) {
  const title = (homepageContent as any)?.heroTitle || (homepageContent as any)?.title || 'From Our Fields to Your Table'
  const subtitle = (homepageContent as any)?.heroSubtitle || 'Sustainably grown, lovingly harvested'
  ...
  return (
    <section className="relative min-h-[80vh] flex items-center overflow-hidden">
      <div
        ...
        style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=1920&q=80&fit=crop)' }}
      />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-32 pb-32">
        <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 mb-8">
          ...
          <span className="text-white/90 text-sm font-medium">Farm Stand Open Wednesday - Sunday</span>
        </div>
