...
export const metadata: Metadata = {
  ...
  description: 'Browse our selection of organic produce, pasture-raised eggs, raw honey, and more from Sunstone Family Farm.',
}

async function getProducts() {
  try {
    const client = getClient()
    const data = await client.raw(GET_PRODUCTS, { first: 50 })
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 bg-white/10 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-primary-200 text-sm font-medium">Fresh from the field</span>
            </div>
            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Farm Products
            </h1>
            <p className="text-xl text-primary-100 max-w-3xl mx-auto">
              Organically grown, sustainably harvested. From our fields to your table.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {items.length === 0 ? (
            <div className="text-center py-16">
              ...
              <h2 className="font-serif text-2xl font-semibold text-gray-700 mb-3">No Products Yet</h2>
              <p className="text-gray-500 max-w-md mx-auto">
                Our farm products will appear here once content is imported. Check back soon!
              </p>
            </div>
          ) : (
