  ...
  return (
    <div className="text-center py-16">
      <div className="bg-white rounded-2xl shadow-sm border border-stone-200 p-12">
        <h1 className="font-serif text-2xl font-semibold text-gray-900 mb-4">Page Not Found</h1>
          ...
          <ErrorBoundary>
            <article className="bg-white rounded-2xl shadow-sm border border-stone-200 overflow-hidden">
              ...
              <div className="p-6 md:p-8">
                <h1 className="font-serif text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 md:mb-6">{title}</h1>
                <div className="prose prose-sm sm:prose lg:prose-lg max-w-none prose-headings:font-serif prose-a:text-primary-700" dangerouslySetInnerHTML={{ __html: bodyHtml }} />
              </div>
            </article>
          </ErrorBoundary>
        </main>
